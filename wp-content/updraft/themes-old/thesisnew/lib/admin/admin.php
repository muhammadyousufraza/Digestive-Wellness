...
/*			'schema' => array(
	...
	public function system_status() {
		...
		echo
			...
			sprintf(__('Database Charset: %s', 'thesis'), esc_attr($wpdb->get_var("SELECT DEFAULT_CHARACTER_SET_NAME FROM information_schema.SCHEMATA WHERE SCHEMA_NAME='". $wpdb->dbname. "';"))), "\n",
