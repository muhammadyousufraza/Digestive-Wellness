...
class thesis_skin {
	...
	public function header_image_html() {
		...
		echo "<a href=\"", esc_url(home_url()), "\"><img id=\"thesis_header_image\" src=\"", esc_url($this->header_image['src']), "\" alt=\"", trim($thesis->api->escht((!empty($thesis->api->options['blogname']) ?
			htmlspecialchars_decode($thesis->api->options['blogname'], ENT_QUOTES). ' ' : ''). __('header image', 'thesis'))), "\" width=\"{$this->header_image['width']}\" height=\"{$this->header_image['height']}\" title=\"", __('click to return home', 'thesis'), "\" /></a><a title=\"Free Phone Consultation\" href=\"http://www.digestivewellness.com.au/contact/contact-free-consultation/\"><img style=\"float: right; /* width: 135px; */ margin-right: 50px; margin-top: -105px;\" src=\"http://www.digestivewellness.com.au/wp-content/uploads/2015/07/headerbutton1607.png\" alt=\"\"></a>\n";
	}
}